...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        //here we are transforming the position of the camera using the smoothDamp method. it needs the current position of the object, where it needs to go, its current velocity, and how long it should take to get to the new Location.
