...
public class UpdatedParallax : MonoBehaviour
{
    ...
    void Start()
    {
        //getting the x value of my starting position
    ...
    void Update()
    {
        ...
        //moving the background based on how far we have travled, changing the start pos of the background to where we are now
