...
{
    // allows us to target a specifc game object to track its transform values 
    public Transform target;

    // creating a new vector3 to offset the camera from the player position. the last value is the z space where we can control the depth of the camera
